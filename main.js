...
const { zip } = require('zip-a-folder')
    ...
    ; (async () => {
        ...
        async function filesReady() {
            ...
            if (!args.attr) args.attr = ['blocks', 'plants', 'civics', 'objects', 'users']
            ...
            if (args.attr.includes('objects')) {
                ...
                if (!args.attr.includes('users')) args.attr.push('users')
            }

            if (args.attr.includes('users')) {
                console.log('[EcoExporter] Exporting Objects...')
                await ncp('processing/src/Users', 'processing/dst/Users')
                console.log('[EcoExporter] Users have been exported!')
            }
